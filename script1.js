...
Array.from(windows).forEach(win => {
    ...
    document.addEventListener('mousemove', (e) => {
        ...
        win.style.left = `${mouseX - offsetX}px`;
        win.style.top = `${mouseY - offsetY}px`;
    });
    ...
    function showUpgrades() {
        ...
        if (money.money >= 0.75 * clothing.cost) {
            if (!document.getElementById("clothingBtn")) {
                showClothing();
            } // todo - var for cloth window vv
            document.getElementById("clothwin").style.display = "block";
        } else {
            document.getElementById("clothwin").style.display = "none";
        }
